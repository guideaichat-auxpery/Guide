...
# Loading Overlay (Themed for Cosmic Education)
st.markdown("""
...
">
    ...
    ">Preparing your digital environment...</div>
</div>
...
<script>
// Hide loading overlay once the page is fully loaded and Streamlit is interactive
