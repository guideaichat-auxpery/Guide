...
- **AI Integration**: Uses OpenAI API (GPT-4o-mini) with dynamic system prompts.
  ...
  - **Imaginarium (Creative AI Chat Space)**: Free-form creative AI chat for educators without strict educational framework constraints. Temperature 1.6 (very high creativity - user requested 8.0-9.0 but OpenAI max is 2.0), 6000 max tokens for longer responses, 40-exchange conversation history (double other interfaces). Clean minimal interface without quick prompts or document upload. System prompt encourages imaginative exploration, follow-up questions, creative alternatives, and detailed explanations while maintaining factual accuracy. Designed for brainstorming, innovative lesson concepts, and thinking outside the box with AI as a creative thinking partner.
