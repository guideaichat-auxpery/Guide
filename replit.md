...
- **AI Integration**: Uses OpenAI API (GPT-4o-mini) with dynamic system prompts.
  ...
  - **Imaginarium (Creative AI Chat Space)**: Free-form creative AI chat for educators without strict educational framework constraints. Temperature 0.9 (high creativity while maintaining coherence - 1.6 caused garbled multilingual output), 6000 max tokens for longer responses, 40-exchange conversation history (double other interfaces). Includes sidebar for chat management (create, rename, delete, switch conversations). System prompt encourages imaginative exploration, follow-up questions, creative alternatives, and detailed explanations while maintaining factual accuracy. Designed for brainstorming, innovative lesson concepts, and thinking outside the box with AI as a creative thinking partner.
...
- **Core Features**:
  ...
  - **AI-Powered Tools**: Includes Great Story Creator, Planning Notes Workspace, Educator Observation Dashboard, Lesson Planning Assistant (with three modes), Big Picture Curriculum Mapping, Student Work Analysis, Imaginarium (creative AI chat space), and an advanced Rubric Generator.
