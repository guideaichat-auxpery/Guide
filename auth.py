...
MONTHLY_PRICE_ID = os.getenv('STRIPE_MONTHLY_PRICE_ID', 'price_1SdjKwGiGxVMaO4BlhLv5uoP')
ANNUAL_PRICE_ID = os.getenv('STRIPE_ANNUAL_PRICE_ID', 'price_1SdjKwGiGxVMaO4B1RmkOjuW')
